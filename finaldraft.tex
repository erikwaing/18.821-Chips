...
\begin{definition}
To define the spread function we once again define a distance on our graph.  The distance for a node $s$ 
$\Psi$ is a function from the finite $d$-boards and is defined
\begin{equation}
