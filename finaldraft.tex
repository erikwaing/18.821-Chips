...
This function maps node labels given as integer coordinates to chip stack sizes. For example, FIGUREREFERENCE if a board $b$ has 8 chips at the node with coordinate $(3,1)$, then $b(3,1) = 8$.
